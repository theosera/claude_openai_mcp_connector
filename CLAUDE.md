...
**2 つの protocol era を 1 エンドポイントで同時に**提供する (2025 era = 従来の sessionful
wiring / 2026-07-28 era = `createMcpHandler` で session 無し)。ChatGPT/Claude.ai web は static bearer 不可なので、
