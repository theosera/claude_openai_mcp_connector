...
| ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`~/Documents/_Claude/_remaining_tasks/<日付>/<席 ID>-remaining-tasks.md` を更新した**       | **統合監視セッション (1e / 次の統合監視) へ `SendMessage` で報告する。** ★ **報告に含める 3 点の本体は、その表自身のヘッダにある** (`_tools/build_day.py` が毎日生成する) — ⛔ **ここに写しを置かない** |
